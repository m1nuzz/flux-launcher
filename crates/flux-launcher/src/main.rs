...
mod tests {
    use super::{
        format_bytes, format_update_progress, google_icon_rgba, icon_completion_generation_changed,
        is_executable_icon_target, is_shutdown_mode, parse_internet_shortcut_icon_location,
