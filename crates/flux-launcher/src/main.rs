...
mod tests {
    use super::{
        ...
        is_shutdown_mode, normalize_built_in_executable_targets, normalize_everything_query,
        parse_internet_shortcut_icon_location, relaunch_mode_for_auto_install,
        resolve_shortcut_icon_path, should_claim_single_instance, ShellIconCache,
        MAX_SHELL_ICON_CACHE_ENTRIES,
    };
