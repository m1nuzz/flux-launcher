...
pub(crate) fn register_activation_hotkey(
    ...
    let query_caret_for_activation = query_caret_position;
    ...
    app.hotkey_handle(activation_hotkey, move |ctx| {
        ...
        if !should_suppress_activation(&settings, fullscreen::foreground_is_fullscreen()) {
            // Clear before toggling visibility (see clear_query_for_activation):
            // clearing only from on_window_hide allowed the old query frame to
            ...
            if settings.clear_query_on_activation {
                super::activation_clear::clear_query_for_activation(
                    query_for_activation,
                    query_caret_for_activation,
                    results_for_activation,
                    selected_id_for_activation,
                    selected_index_for_activation,
                    selection_touched_for_activation,
                    show_results_for_activation,
                    history_mode_for_activation,
                    history_cursor_for_activation,
                    action_mode_for_activation,
                    action_index_for_activation,
                    action_items_for_activation,
                    inline_completion_for_activation,
                    scroll_request_for_activation,
                    settings_visible_for_activation,
                    launcher_width,
                    launcher_height,
                    size_for_activation.clone(),
                );
            }
